...
parser.add_argument('--data_path', type=str, help='path to the data', default='/media/q/data/datasets/VOC/VOC2007_test/')
# required=True)
...
parser.add_argument('--checkpoint_path', type=str, help='path to a specific checkpoint to load',
                    #default="./ckpt/")
                    default='./ckpt/ckpt_noHash_ep00009_loss22.5758_lr0.001.pth.tar')
