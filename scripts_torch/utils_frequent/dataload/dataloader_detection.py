...
# import cv2
# from utils_frequent.img_augument.imgaug_wo_shape import ImgAugWithoutShape
# from utils_frequent.img_augument.imgaug_w_shape import ImgAugWithShape
#
# """
# 一个image一个anno.txt
# imageName.txt
...
#         imgAug = cv2.resize(imgAug, self.netInputSize)
#         wsRate = self.netInputSize[0]/img.shape[1]
#         hsRate = self.netInputSize[1]/img.shape[0]
...
#             wsRate2 = imgOutSize[0] / imgAug.shape[1]
#             hsRate2 = imgOutSize[1] / imgAug.shape[0]
