...
if __name__ == '__main__':
    ...
    csv_file = '/media/q/deep/me/data/m2nist/annotation/bbox.csv'

    #该路径下存放所有的图片
    image_dir = "/media/q/deep/me/data/m2nist/images/"

    #将整理好的coco 格式存放在什么位置
    saved_coco_path = "/media/q/deep/me/data/m2nist/coco_format/"
